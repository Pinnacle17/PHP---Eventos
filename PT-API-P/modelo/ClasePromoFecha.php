<?php
    ...
    class PromoFecha extends Boleto{
        ...
        public static function UpdateStockPromoFec($id_promo, $stock){
            $consulta = "UPDATE promo_fec SET cantidad_act_fec = '$stock' WHERE id_promo_fec = '$id_promo'"; 
            $resultado = BD::consultaSelect($consulta);
            self::CronPromoFec(); 
            return $resultado;
        }
        public static function CronPromoFec(){
            $consulta = "UPDATE promo_fec SET estado_promo = '1' WHERE cantidad_act_fec > '0'"; 
            $resultado = BD::consultaSelect($consulta); 
            $consulta = "UPDATE promo_fec SET estado_promo = '0' WHERE cantidad_act_fec <= '0'"; 
            $resultado = BD::consultaSelect($consulta);
            return $resultado;
        }
    }
